...
export default function VocabsDefinePractice({
  ...
  const prevRestartKeyRef = useRef(defineState.restartKey);
  if (defineState.restartKey !== prevRestartKeyRef.current) {
    prevRestartKeyRef.current = defineState.restartKey;
