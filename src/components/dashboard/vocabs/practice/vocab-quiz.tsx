...
interface VocabsVocabQuizPracticeProps {
...
export default function VocabsVocabQuizPractice({
  onBackToPracticeSelection,
}: VocabsVocabQuizPracticeProps = {}) {
  ...
  const updateWordPerformance = (
    ...
    setPracticePerformance((prevData) => {
      ...
      const newStrugglingAreas =
        !isCorrect && !wordPerf.strugglingAreas.includes("vocab-quiz")
          ? ([
    ...
    return (
      <div className="w-full flex flex-col min-h-[80vh] items-center justify-center p-8">
        <div className="text-center space-y-6 max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900">No Words to Quiz</h2>
          <p className="text-gray-600">
            You need to learn some vocabulary words first before taking a quiz.
          </p>
          <Button
            variant="default"
