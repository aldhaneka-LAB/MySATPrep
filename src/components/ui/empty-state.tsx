...
export const EmptyState = forwardRef<HTMLElement, EmptyStateProps>(
  (
    ...
    const getVariantClasses = (variant: Variant, theme: Theme) => {
    ...
    const getButtonClasses = (size: Size, theme: Theme) => {
      const sizeClasses = {
      ...
      <LazyMotion features={domAnimation}>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            {action && (
              <motion.div className="cursor-pointer" variants={BUTTON_VARIANTS}>
                <motion.button
                  type="button"
